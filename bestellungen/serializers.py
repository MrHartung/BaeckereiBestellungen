...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'email', 'username', 'first_name', 'last_name', 'is_verified_email']
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if not user.is_verified_email:
            raise serializers.ValidationError("Bitte verifizieren Sie zuerst Ihre E-Mail-Adresse.")
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'price_cents', 'price_euro', 'available',
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'quantity', 'unit_price_cents', 'subtotal_cents', 'subtotal_euro'
        ]
    ...
    def validate_sku(self, value):
        ...
        try:
            ...
            if not product.available:
                raise serializers.ValidationError(f"Produkt '{product.name}' ist nicht verfügbar.")
            return value
        except Product.DoesNotExist:
            raise serializers.ValidationError(f"Produkt mit SKU '{value}' existiert nicht.")
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'user', 'user_email', 'status', 'total_cents', 'total_euro',
            'placed_at', 'exported_at', 'created_at', 'updated_at', 'items'
        ]
        read_only_fields = [
            'id', 'user', 'status', 'total_cents', 'placed_at',
...
class OrderCreateSerializer(serializers.Serializer):
    ...
    def validate_items(self, value):
        ...
        if not value:
            raise serializers.ValidationError("Bestellung muss mindestens ein Produkt enthalten.")
        return value
